...
let venomDerrotado = false;
let musicaVenom = null;
...
function handleTela3Button() {
    ...
    } else if (venomDerrotado) {
        mostrarTelaComSom('tela5');
...
const spiders = [{
    id: 1,
    nome: "Homem Aranha (Insomniac)",
    img: "https://i.postimg.cc/vmGy5f9y/Spider-Man-from-MSM-render.webp",
    selecionado: false
}, {
    id: 2,
    nome: "Homem Aranha (Andrew Garfield)",
    img: "https://i.postimg.cc/YS7FgnbS/df4bajc-2c8eca60-7143-45ba-8355-05fa5a7b84a4.png",
    selecionado: false
}, {
    id: 3,
    nome: "Spider Gwen",
    img: "https://i.postimg.cc/FKchCCnN/fixed-which-gwen-stacy-spider-woman-outfit-is-better-v0-q8nlf4ak6sxb1.webp",
    selecionado: false
}, {
    id: 4,
    nome: "Homem Aranha (Miles Morales)",
    img: "https://i.postimg.cc/BQ1Pz9z6/pngkey-com-wish-png-7995924.png",
    selecionado: false
}, {
    id: 5,
    nome: "Homem Aranha (Lego)",
    img: "https://i.postimg.cc/rw108GM2/pngwing-com-4.png",
    selecionado: false
}, {
    id: 6,
    nome: "Homem Aranha Simbionte",
    img: "https://i.postimg.cc/FHnZXVg4/clipart626887.png",
    selecionado: false
}, {
    id: 7,
    nome: "Homem Aranha (MCU)",
    img: "https://i.postimg.cc/25pDWFjJ/spider-man-2nd-homemade-suit-nwh-png11-by-iwasboredsoididthis-dfy46go-pre.png",
    selecionado: false
}, {
    id: 8,
    nome: "Homem Aranha (Tobey Maguire)",
    img: "https://i.postimg.cc/G201ChPh/pngimg-com-spider-man-PNG34.png",
    selecionado: false
}, {
    id: 9,
    nome: "Homem Aranha 2099",
    img: "https://i.postimg.cc/CMJS2qJB/spider-man-2099-render-by-kiss-and-kancer-defqomh-pre.png",
    selecionado: false
}, {
    id: 10,
    nome: "Homem Aranha Superior",
    img: "https://i.postimg.cc/Yq9B2t7r/klipartz-com-1.png",
    selecionado: false
}, {
    id: 11,
    nome: "Silk",
    img: "https://i.postimg.cc/Zn52qx17/Silk-Dialogue-1.webp",
    selecionado: false
}, {
    id: 12,
    nome: "Venom",
    img: "https://i.postimg.cc/gJX4tBbP/pngimg-com-venom-PNG41.png",
    selecionado: false
}, ];
...
function jogar(spiderId) {
    ...
    if (derrota && spiderSelecionado.nome.toLowerCase().includes('simbionte')) {
        ...
        observerSimbionte.observe(container4, {
            attributes: true
        });
    } else {
        spiderSimbionteDerrotado = false;
    ...
    if (derrota && spiderSelecionado.nome.toLowerCase().includes('venom')) {
        ...
        observerVenom.observe(container5, {
            attributes: true
        });
    } else {
        venomDerrotado = false;
    ...
    if (derrota && spiderSelecionado.nome.toLowerCase().includes('tobey')) {
        ...
        observerTobey.observe(container6, {
            attributes: true
        });
    } else {
        tobeyDerrotado = false;
